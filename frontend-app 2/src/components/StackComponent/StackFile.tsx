...
import type { SearchParams, StackTag } from '@/types/content'
...
export default function StackFile({ tags, searchParams }: StackFileProps) {
...
const returnStackIcon = (stackName?: string): ReactNode => {
